...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post :create, delivery: { customer_id: @delivery.customer_id, deadline: @delivery.deadline, reference: @delivery.reference }
    end
  ...
  test "should update delivery" do
    put :update, id: @delivery, delivery: { customer_id: @delivery.customer_id, deadline: @delivery.deadline, reference: @delivery.reference }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
